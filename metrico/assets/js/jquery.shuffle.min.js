...
var shufflemasonary = (function($) {
    'use strict';
    var $grid = $('#grid'), //locate what we want to sort
        $filterOptions = $( '.masonary-tab-sorting li'), //locate the filter categories
        ...
        setupFilters = function() {
            ...
            $btns.on('click', function(e) {
                ...
                if (!isActive) {
                    $('.masonary-tab-sorting li a').removeClass('active');
                }
